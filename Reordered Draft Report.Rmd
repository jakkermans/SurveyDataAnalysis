...
totalCalculator2 <- function(used_dates) {
  ...
  barplot(tot_frame$`Reported infections per 100.000`, 
          col = "greenyellow",
          xlab = "Date", 
          ylab = "Reported infections (1:100,000)", 
          names.arg = as.Date(dates[-1]))
...
differenceCalculator2 <- function(used_dates) {
  ...
  barplot(diff_frame$`Increase in reported infections per 100.000`, 
          col = "greenyellow",
          xlab = "Date", 
          ylab = "New reported infections (1:100,000)", 
          names.arg = as.Date(dates[-1]))
...
As we mentioned in the literature review, infected people have RNA particles in their stool that end up in the sewage. If more people are infected we would expect that there are more RNA particles in the sewage. Then, the total amount of RNA particles in the sewage per day should follow the same course as the total number of infections per day over time.  To find out if this holds for the epidemic in the Netherlands we plotted the total amount of RNA particles found per day. The figure is shown below. The shape of the plot is different from the shape of the plot of the total number of infections per day. So the total amount of RNA particles in the sewage per day does not follow the same course as the total number of infections per day over time.
...
```
Then, maybe the mean number of RNA particles in the sewage per day does follow the same tendency as the number of infections over time. Below the plot of the mean number of RNA particles over time is shown. This plot also does not have the same shape as the plot of the number of infections per day. So the number of installations from which a sample was taken does not explain why the total amount of RNA particles does not have the same course as the number of infections over time. So something else is going on. 
