...
\begin{APAenumerate}
  ...
  \setlength{\parskip}{0pt}
   ...
   \item What is the mean level of RNA particles found in the water per 100,000 inhabitants? (Section \ref{sec:sub3})
   \item What is the relationship between RNA particles and the total number of infections on one given moment? (Section \ref{sec:sub4})
   \item How does this relationship look over time? (Section \ref{sec:sub5})
\end{APAenumerate}

\section{Methodology and Results}
\label{sec:metresults}

In this section, the different subquestions are treated consecutively. First, the methodology that was used to answer the specfic question is described. Second, the results are displayed and discussed immediately afterwards. 
