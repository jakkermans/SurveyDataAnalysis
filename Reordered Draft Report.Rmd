...
#### RE-EVALUATE IF / HOW WE WANT TO USE THIS SECTION
...
virusCalculator_new_totals <- function(used_dates) {
  ...
  for (i in 1:length(totals)) {
    ...
    totals[i] <- sum(df1$TP_RNA.flow.per.100000, na.rm = TRUE)
  }
...
```{r 6, results = 'hide', fig.align = "center", fig.cap = x8, fig.height = 4, fig.width = 5.5, fig.pos = "H"}
x8 <- paste(
