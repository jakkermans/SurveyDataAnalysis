...
As RNA can be used as an indicator for estimating the true number of covid cases, this project attempts to build a model that estimates the true number of new positive cases in a security region on a given day based on the RNA flow seven days prior. We work towards this goal through asking and answering the following sub-questions:
\begin{APAenumerate}
